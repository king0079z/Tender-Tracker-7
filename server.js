...
const createClient = () => new Client({
  host: process.env.VITE_AZURE_DB_HOST || 'localhost',
  database: process.env.VITE_AZURE_DB_NAME || 'tender_tracking',
  user: process.env.VITE_AZURE_DB_USER || 'postgres',
  password: process.env.VITE_AZURE_DB_PASSWORD || 'postgres',
  port: 5432,
